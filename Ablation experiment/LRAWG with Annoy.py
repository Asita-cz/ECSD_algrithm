...
def showDataSet3(i,fake,data_p,data_n,str):
    """
       数据可视化
       Parameters:
           dataMat - 数据矩阵
    ...
    plt.savefig('./myplot/3863/' + str + '.png')
    plt.show ()

def showDataSet3_no_N(i,fake,data_p,str):
    """
       数据可视化
       Parameters:
           dataMat - 数据矩阵
...
def showDataSet3_no_P(i,fake,data_n,str):
    """
       数据可视化
       Parameters:
           dataMat - 数据矩阵
...
def showDataSet2(data_p,data_n,str):
    """
       数据可视化
       Parameters:
           dataMat - 数据矩阵
...
def showDataSet1(i,data_p,data_n,str):
    """
       数据可视化
       Parameters:
           dataMat - 数据矩阵
...
if __name__ == '__main__':
    ...
    dataArr, testArr, LabelArr, testLabelArr= load_data(path,dim,testsize = 0.3)
    ...
    if ((np.shape(dataArr_N1)[0])/(np.shape(dataArr_P1)[0]))<= 250:
        ...
        # 训练集数据变换
        lmnn = LargeMarginNearestNeighbor(n_neighbors=n_neighbors_lmnn, verbose=2, random_state=0)
    ...
    for i in range(len(leaf)):
        ...
        # print(SubDataArr_n)
        # 子空间
        str_org_subspace = str(i)+'st'+'_org_subspace'
        showDataSet1(i, SubDataArr_p, SubDataArr_n,str_org_subspace)
