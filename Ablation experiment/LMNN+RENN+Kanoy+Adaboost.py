...
if __name__ == '__main__':
    ...
    for i in range(len(leaf)):
        ...
        train_y = prepare_list['subspace_matrix' + str(i)][:, np.shape(prepare_list['subspace_matrix' + str(i)])[1] - 1]
        train_x = np.delete(prepare_list['subspace_matrix' + str(i)],
    ...
    print("accuracy: ", accuracy_score(np.mat(testLabelArr).T, predicts)*100)
